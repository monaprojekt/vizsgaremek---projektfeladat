  	...
  	<body>
	  	...
	  	<nav class="navbar navbar-expand-lg navbar-dark bg-success navbar-fixed-top w3-card-2 topnav notranslate">
			<div class="container-fluid">
				<a href="th.php" class="navbar-brand">Telephelyek</a>
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<div class="navbar-nav">
						<a href="th_list.php" class="nav-item nav-link">Listázás</a>
						<a href="th_mod.php" class="nav-item nav-link">Módosítás</a>
                		<a href="th_ad.php" class="nav-item nav-link">Felvitel</a>
						<a href="th_tor.php" class="nav-item nav-link">Törlés</a>
						<a href="th_arch.php" class="nav-item nav-link">Archiválás</a>
					</div>
		...
		<div class="container-fluid">
			...
			<div class="row align-items-center">
                ...
                <div class="col-sm-9 col-md-6 col-lg-4 text-center">
                    <br>
                    <img class="img-thumbnail" src="hevlogo.png" alt="">
				</div>
